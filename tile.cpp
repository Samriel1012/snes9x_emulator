...
#define LARGE_ADD_PIXEL(s, p) \
  (Depth[z + GFX.DepthDelta] ? (Depth[z + GFX.DepthDelta] != 1 ? COLOR_ADD(p, *(s + GFX.Delta)) : COLOR_ADD(p, GFX.FixedColour)) : p)
...
#define LARGE_ADD_PIXEL1_2(s, p) \
  ((uint16_t)(Depth[z + GFX.DepthDelta] ? (Depth[z + GFX.DepthDelta] != 1 ? COLOR_ADD1_2(p, *(s + GFX.Delta)) : COLOR_ADD(p, GFX.FixedColour)) : p))
...
#define LARGE_SUB_PIXEL(s, p) \
  (Depth[z + GFX.DepthDelta] ? (Depth[z + GFX.DepthDelta] != 1 ? COLOR_SUB(p, *(s + GFX.Delta)) : COLOR_SUB(p, GFX.FixedColour)) : p)
...
#define LARGE_SUB_PIXEL1_2(s, p) \
  (Depth[z + GFX.DepthDelta] ? (Depth[z + GFX.DepthDelta] != 1 ? COLOR_SUB1_2(p, *(s + GFX.Delta)) : COLOR_SUB(p, GFX.FixedColour)) : p)
